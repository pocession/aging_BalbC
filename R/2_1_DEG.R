...
## GTF data ====
gene_info <- getGeneInfo(here::here(doc_dir, "gencode.vM10.annotation.gtf"))
head(gene_info)
...
## Save count
write.csv(count_annotated, here::here(result_dir, "Statistics", "TPM_all_organ_all_age.csv"), row.names = FALSE)
...
## Save count
write.csv(count_annotated, here::here(result_dir, "Statistics", "TPM_filtered_all_organ_all_age.csv"), row.names = FALSE)
